...
Feature: Parallel seven test testing.
  ...
  Scenario: Simple seven parallel test
    When I have a simple test
    Then my test "passes"

  Scenario: Second seven  parallel test
    When I have a simple test
    Then my test "fails"


  Scenario Outline: Third seven parallel set of tests
    When I have a simple test
    Then my test "<ps>"
    Examples:
    |  ps    |
